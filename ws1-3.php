...
<div class="container mt-3">
  <button id="n1" type="button" class="btn btn-primary">Number1</button>
  <button id="n2" type="button" class="btn btn-primary">Number2</button>
  <button id="n3" type="button" class="btn btn-primary">Number3</button>
  <button id="n4" type="button" class="btn btn-primary">Number4</button>
  <button id="n5" type="button" class="btn btn-primary">Number5</button>
